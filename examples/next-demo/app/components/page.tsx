...
<TradeButton ticker="${TICKER}" side="no" variant="ghost" />`}
            ...
            <Showcase
              name="ShareCard"
              wide
              description="Copy-link and tweet buttons. When the share URL points at a page with OG meta tags, Twitter / Slack / iMessage / Discord / LinkedIn render the unfurled image inline after the post is sent."
              code={`<ShareCard
  ticker="${TICKER}"
